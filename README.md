...
> Be patient! In ~3 mins your app is live, at your [app url](https://newton-pqtint8.newton.wiki/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://newton-pqtint8.newton.wiki/
...
```
git clone git@github.com:Blackadams/newton-pqtint8.git
```
